...
const questions = [
  { q:"ถ้าเจอสถานการณ์อันตราย คุณจะทำอะไร?", img:"/images/img.harry.jpg", answers:[
  ...
  { q:"คุณอยากได้สมบัติวิเศษแบบไหน?", img:"/images/img.harry.jpg", answers:[
  ...
  { q:"คุณชอบทำงานแบบไหน?", img:"/images/img.harry.jpg", answers:[
  ...
  { q:"คุณชอบอยู่กับกลุ่มแบบไหน?", img:"/images/img.harry.jpg", answers:[
  ...
  { q:"ถ้าต้องแก้ปัญหาใหญ่ คุณจะทำอย่างไร?", img:"/images/img.harry.jpg", answers:[
  ...
  { q:"คุณอยากได้สัตว์เลี้ยงแบบไหน?", img:"/images/img.harry.jpg", answers:[
  ...
  { q:"วันหยุดของคุณเป็นแบบไหน?", img:"/images/img.harry.jpg", answers:[
  ...
  { q:"คุณอยากได้พลังวิเศษแบบไหน?", img:"/images/img.harry.jpg", answers:[
  ...
  { q:"คุณจัดการกับความผิดพลาดอย่างไร?", img:"/images/img.harry.jpg", answers:[
  ...
  { q:"คุณชอบเรียนรู้แบบไหน?", img:"/images/img.harry.jpg", answers:[
  ...
  { q:"คุณชอบใช้เวลาแบบไหนกับเพื่อน?", img:"/images/img.harry.jpg", answers:[
  ...
  { q:"คุณจัดการความกลัวอย่างไร?", img:"/images/img.harry.jpg", answers:[
  ...
  { q:"คุณจะทำอย่างไรถ้าต้องตัดสินใจยาก?", img:"/images/img.harry.jpg", answers:[
  ...
  { q:"คุณอยากได้เพื่อนแบบไหน?", img:"/images/img.harry.jpg", answers:[
  ...
  { q:"คุณอยากเรียนรู้เรื่องอะไร?", img:"/images/img.harry.jpg", answers:[
  ...
  { q:"คุณอยากได้อาวุธวิเศษแบบไหน?", img:"/images/img.harry.jpg", answers:[
  ...
  { q:"คุณอยากได้ความสามารถพิเศษแบบไหน?", img:"/images/img.harry.jpg", answers:[
  ...
  { q:"คุณจะตอบสนองต่อความท้าทายอย่างไร?", img:"/images/img.harry.jpg", answers:[
  ...
  { q:"คุณอยากได้สถานที่พักผ่อนแบบไหน?", img:"/images/img.harry.jpg", answers:[
  ...
  { q:"คุณอยากได้เพื่อนร่วมทีมแบบไหน?", img:"/images/img.harry.jpg", answers:[
  ...
  { q:"คุณชอบกิจกรรมแบบไหนในวันว่าง?", img:"/images/img.harry.jpg", answers:[
  ...
  { q:"คุณจะตอบสนองต่อความสำเร็จอย่างไร?", img:"/images/img.harry.jpg", answers:[
  ...
  { q:"คุณอยากได้เวทมนตร์ประเภทไหน?", img:"/images/img.harry.jpg", answers:[
  ...
  { q:"คุณจะทำอย่างไรกับความลับ?", img:"/images/img.harry.jpg", answers:[
  ...
  { q:"คุณอยากได้พลังเหนือธรรมชาติแบบไหน?", img:"/images/img.harry.jpg", answers:[
  ...
  { q:"คุณอยากใช้เวลาช่วงเย็นอย่างไร?", img:"/images/img.harry.jpg", answers:[
  ...
  { q:"คุณอยากได้สิ่งของวิเศษประเภทไหน?", img:"/images/img.harry.jpg", answers:[
  ...
  { q:"คุณอยากได้พลังด้านอารมณ์แบบไหน?", img:"/images/img.harry.jpg", answers:[
  ...
  { q:"คุณอยากเป็นผู้นำแบบไหน?", img:"/images/img.harry.jpg", answers:[
  ...
  { q:"คุณอยากได้การผจญภัยแบบไหน?", img:"/images/img.harry.jpg", answers:[
  ...
  { q:"คุณอยากได้สกิลพิเศษด้านไหน?", img:"/images/img.harry.jpg", answers:[
  ...
  { q:"คุณอยากได้เพื่อนสนิทแบบไหน?", img:"/images/img.harry.jpg", answers:[
    {text:"กล้าหาญและพร้อมสู้", house:"Gryffindor", class:"gryffindor"},
    {text:"ฉลาดและช่างคิด", house:"Ravenclaw", class:"ravenclaw"},
    {text:"ซื่อสัตย์และช่วยเหลือ", house:"Hufflepuff", class:"hufflepuff"},
    {text:"ทะเยอทะยานและมีแผนการ", house:"Slytherin", class:"slytherin"}
  ]},
  { q:"คุณอยากได้อุปกรณ์เวทมนตร์แบบไหน?", img:"/images/img.harry.jpg", answers:[
    {text:"ดาบหรืออาวุธกล้าหาญ", house:"Gryffindor", class:"gryffindor"},
  ...
  { q:"คุณอยากได้พลังปกป้องแบบไหน?", img:"/images/img.harry.jpg", answers:[
  ...
  { q:"คุณอยากมีทักษะพิเศษด้านไหน?", img:"/images/img.harry.jpg", answers:[
  ...
  { q:"คุณจะทำอย่างไรเมื่อเห็นคนถูกเอาเปรียบ?", img:"/images/img.harry.jpg", answers:[
  ...
  { q:"คุณคิดว่าอะไรสำคัญที่สุดในทีม?", img:"/images/img.harry.jpg", answers:[
  ...
  { q:"คุณจะจัดการกับความล้มเหลวอย่างไร?", img:"/images/img.harry.jpg", answers:[
  ...
  { q:"คุณชอบแก้ปัญหาด้วยวิธีไหน?", img:"/images/img.harry.jpg", answers:[
  ...
  { q:"คุณอยากให้คนอื่นจดจำข้อดีของคุณอะไร?", img:"/images/img.harry.jpg", answers:[
  ...
  { q:"คุณอยากเรียนรู้อะไรจากผู้ใหญ่ที่สุด?", img:"/images/img.harry.jpg", answers:[
  ...
  { q:"คุณจะทำอย่างไรเมื่อเพื่อนต้องการความช่วยเหลือ?", img:"/images/img.harry.jpg", answers:[
  ...
  { q:"คุณคิดว่าความกล้าหาญหมายถึงอะไร?", img:"/images/img.harry.jpg", answers:[
  ...
  { q:"คุณจะใช้ทรัพยากรจำกัดอย่างไรให้เกิดประโยชน์ที่สุด?", img:"/images/img.harry.jpg", answers:[
  ...
  { q:"ถ้ามีโอกาสเปลี่ยนแปลงโลก คุณจะทำอะไรแรก?", img:"/images/img.harry.jpg", answers:[
  ...
  { q:"คุณจะรับมือกับคู่แข่งที่เก่งกว่าอย่างไร?", img:"/images/img.harry.jpg", answers:[
  ...
  { q:"คุณจะเลือกช่วยใครเมื่อต้องเลือกได้แค่คนเดียว?", img:"/images/img.harry.jpg", answers:[
  ...
  { q:"คุณอยากได้อาชีพในโลกเวทมนตร์แบบไหน?", img:"/images/img.harry.jpg", answers:[
  ...
  { q:"คุณอยากมีสัญลักษณ์ประจำตัวแบบไหน?", img:"/images/img.harry.jpg", answers:[
  ...
  { q:"อะไรทำให้คุณภูมิใจที่สุด?", img:"/images/img.harry.jpg", answers:[
